...
export function GiftsSection() {
  ...
  return (
    <section
      className="h-[100dvh] overflow-y-auto no-scrollbar w-full flex flex-col snap-start snap-always relative"
                ...
                */}
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ fontSize: 12, color: C.textLight, margin: '0 0 3px' }}>Bank · GTBank</p>
                    <p style={{ fontSize: 'clamp(17px, 3.8vw, 24px)', fontFamily: 'serif', color: '#2c2c2c', letterSpacing: '0.1em', margin: '4px 0' }}>
                      0123456789
                    </p>
                    <p style={{ fontSize: 12, color: C.textLight, margin: '0 0 14px' }}>Account Name · Ejoke &amp; Lily</p>
                ...
                >
                  ...
                  */}
                  ...
                  >
                    ...
                    >
                      {/* Envelope base */}
                      <rect x="0" y="0" width={W} height={H} rx="14" ry="14" fill={C.body} />
                      ...
                      <rect x="1" y="1" width={W - 2} height={H - 2} rx="13" ry="13" fill="none" stroke={C.border} strokeWidth="2" />
                    </svg>
